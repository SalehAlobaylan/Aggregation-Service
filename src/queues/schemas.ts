...
export interface PipelineRepairDispatchJob {
  trigger: "auto";
}
...
export interface ContentStageCorrelation {
  request_id: string;
  attempt_id: string;
  claim_token: string;
  fence_token: string;
...
export interface ContentStageClaim {
  schema_version: "content-stage/v1";
  request_id: string;
  attempt_id: string;
  tenant_id: string;
...
export interface ContentStageJob {
...
export interface AtomizationJob {
  contentItemId: string;
  reason:
    "media-ready" | "transcript-ready" | "manual" | "reatomize" | "sweeper";
  contentStageClaim?: ContentStageClaim;
...
export const QUEUE_NAMES = {
  ...
  MEDIA: "media-queue",
  AI: "ai-queue",
  NEWS_ASSET: "news-asset-queue",
  NEWS_ENRICHMENT: "news-enrichment-queue",
  NEWS_OPTIONAL: "news-optional-queue",
  PODS_MEDIA: "pods-media-queue",
  PODS_COMPLETION: "pods-completion-queue",
  PODS_OPTIONAL: "pods-optional-queue",
  PODS_ATOMIZATION: "pods-atomization-queue",
  NEWS_STAGE_DLQ: "news-stage-dlq",
  PODS_STAGE_DLQ: "pods-stage-dlq",
